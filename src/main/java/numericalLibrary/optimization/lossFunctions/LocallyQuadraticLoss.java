 ...
 * where:
 * - f is a {@link ModelFunction} to be optimized,
 * - x_i is the i-th input to the {@link ModelFunction},
 * - \theta is the parameter vector, represented as a column {@link Matrix}.
